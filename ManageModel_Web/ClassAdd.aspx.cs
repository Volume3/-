...
public partial class ManageModel_Web_ClassAdd : System.Web.UI.Page
{
    ...
    private void DropDownListBind()
    {
        ...
        this.TeacherDDList.DataSource =
                                               DDLDataSet.Tables["TeacherTable"];
    ...
    protected void InsertBtn_Click1(object sender, EventArgs e)
    {
        ...
        ClassInsertConn.ConnectionString =
