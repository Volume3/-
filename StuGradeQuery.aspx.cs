...
public partial class StuGradeQuery : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        StuNameLabel.Text = "<学号：" + Session["StuID"].ToString() + "    姓名：" + Session["StuName"].ToString() + ">";
        ...
        SqlCommand StuGradeCmd = new SqlCommand("SELECT CourseName 课程名称, TotalScore 课程成绩, RetestScore 补考成绩 FROM TB_Grade TG join TB_Course TC on TG.CourseID = TC.CourseID AND StuID='" + Session["StuID"].ToString() + "'",StuGradeConn);
